...
INSERT INTO `hotels` (`id`, `name`, `slug`, `city`, `created_at`) VALUES
(1, 'Default Hotel', 'default', 'Najran', '2025-09-05 06:06:26'),
(2, 'فندق السعادة', 'alsaadah', 'Riyadh', '2025-09-08 04:45:35'),
(3, 'Sea View Hotel', 'seaview', 'Jeddah', '2025-09-08 04:45:35');
...
INSERT INTO `service_sections` (`id`, `code`, `title_en`, `title_ar`, `hotel_id`) VALUES
(1, 'hotel_services', 'Hotel Services', 'خدمات الفندق', 1),
(2, 'external_services', 'External Services', 'الخدمات الخارجية', 1),
(3, 'car_rental', 'Car Rental', 'تأجير سيارات', 1),
(4, 'tourist_places', 'Tourist Places', 'الأماكن السياحية', 1),
(5, 'events', 'Events', 'الفعاليات', 1),
(11, 'food_beverage', 'Food & Beverage', 'مأكولات ومشروبات', NULL),
(12, 'laundry', 'Laundry', 'غسيل الملابس', NULL),
(13, 'room_cleaning', 'Room Cleaning', 'تنظيف الغرفة', NULL);
