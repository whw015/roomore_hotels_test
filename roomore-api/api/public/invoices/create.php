 ...
 * Requires: code|hotel_code|X-Hotel-Code + one of (email|phone|token) + (booking_code|id)
 * Optional JSON Body: items[{description_en,description_ar,qty,unit_price}], notes_en, notes_ar, tax_percent
 */
